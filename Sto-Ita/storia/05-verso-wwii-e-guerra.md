...
## 7. Il genocidio degli ebrei (Shoah)

Con l'invasione dell'URSS (Operazione Barbarossa) la persecuzione nazista degli ebrei entra nella fase dello **sterminio sistematico**.
...
A differenza dei campi di concentramento (Dachau, Buchenwald, ecc.), i **campi di sterminio** sono dedicati all'**uccisione di massa industriale** mediante camere a gas:

- **Chełmno** (dicembre 1941): primo, con gas in camion.
- **Operazione Reinhard** (1942-1943): campi di **Bełżec, Sobibór, Treblinka** in Polonia, dove vengono sterminati gli ebrei polacchi.
- **Auschwitz-Birkenau**: il complesso più grande, con camere a gas a **Zyklon B** e forni crematori. Picco operativo: estate 1944, deportazione degli ebrei ungheresi (~437.000 in 8 settimane).

### Le vittime

- **~6 milioni di ebrei** sterminati (circa 2/3 degli ebrei europei).
- Inoltre: oltre **3 milioni di prigionieri di guerra sovietici**, **220.000-500.000 Rom e Sinti** (*Porajmos*), centinaia di migliaia di polacchi, disabili (programma **Aktion T4**), omosessuali, testimoni di Geova, oppositori politici.

### La liberazione e la memoria

- **27 gennaio 1945**: l'Armata Rossa libera **Auschwitz**. È oggi la **Giornata della Memoria** (istituita dall'ONU nel 2005).
- Il termine **Shoah** ("catastrofe" in ebraico) è preferito a "Olocausto" perché privo di connotazioni religiose.
...
## 12. La sconfitta del Giappone e le bombe atomiche
...
- **26 giugno 1945**: a **San Francisco**, 50 Stati firmano la **Carta delle Nazioni Unite**. L'ONU entra in vigore il 24 ottobre 1945.
- Sede: **New York**.
- **Obiettivi**: mantenere la pace, sviluppare relazioni amichevoli tra le nazioni, promuovere i diritti umani e lo sviluppo economico-sociale.
- **Struttura**:
  - **Assemblea generale**: tutti gli Stati membri, un voto a testa.
  - **Consiglio di Sicurezza**: 5 membri permanenti con **diritto di veto** (USA, URSS, UK, Cina, Francia) + 10 membri non permanenti.
  - **Segretario Generale**, Corte Internazionale di Giustizia, agenzie specializzate (UNESCO, FAO, OMS, UNICEF…).

### La Dichiarazione Universale dei Diritti Umani

**10 dicembre 1948**: l'Assemblea ONU approva a Parigi la **Dichiarazione Universale dei Diritti dell'Uomo**, redatta da una commissione presieduta da **Eleanor Roosevelt**. Codifica diritti civili, politici, economici e sociali validi per "ogni essere umano". Risposta morale all'esperienza della Shoah e dei totalitarismi.

### Il bilancio della guerra

- **~60 milioni di morti**, in maggioranza civili (per la prima volta nella storia).
- **URSS**: ~27 milioni di morti (le perdite più gravi).
- **Cina**: ~15 milioni.
- **Germania**: ~7 milioni.
- **Polonia**: ~6 milioni (di cui 3 milioni di ebrei).
- **Giappone**: ~3 milioni.
- **Italia**: ~440.000.
- **Shoah**: ~6 milioni di ebrei sterminati.
- Distruzione materiale immensa: città rase al suolo, economie collassate.
- Spostamenti di popolazione: ~50 milioni di profughi (in particolare ~12 milioni di tedeschi espulsi dall'Europa orientale).
- L'Europa è ridotta a teatro di rovine: la centralità mondiale passa alle due nuove superpotenze, **USA e URSS**.
...
| 6 giugno 1944 | D-Day: sbarco in Normandia (Overlord) |
| 25 agosto 1944 | Liberazione di Parigi |
| 4-11 febbraio 1945 | Conferenza di Yalta |
| 25 aprile 1945 | Insurrezione del Nord Italia |
| 28 aprile 1945 | Mussolini fucilato a Giulino di Mezzegra |
| 30 aprile 1945 | Suicidio di Hitler |
| 7-8 maggio 1945 | Resa della Germania (V-E Day) |
| 26 giugno 1945 | Carta delle Nazioni Unite (San Francisco) |
| 6 e 9 agosto 1945 | Bombe atomiche su Hiroshima e Nagasaki |
| 2 settembre 1945 | Resa del Giappone — fine WWII |
