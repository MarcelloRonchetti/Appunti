...
La poesia antinovecentista rifiuta il tono solenne del poeta-vate.
...
## 7. Differenza con l'Ermetismo

| Aspetto | Ermetismo | Linea antinovecentista |
|---|---|---|
| Linguaggio | Oscuro, allusivo, concentrato | Più chiaro, discorsivo, quotidiano |
| Sintassi | Spezzata, nominale | Più regolare |
| Rapporto con il lettore | Difficile, selettivo | Più comunicativo |
| Temi | Assoluto, mistero, interiorità | Vita comune, dolore, realtà concreta |
| Modelli | Simbolismo francese | Tradizione italiana, Leopardi, classicismo |
| Autori | Ungaretti precursore, Quasimodo, Luzi | Saba, Cardarelli, in parte Montale |

## 8. Importanza della linea antinovecentista
...
| Termine | Significato |
|---|---|
| Antinovecentismo | Tendenza poetica chiara e antiretorica |
| Poesia onesta | Ideale di Saba: sincerità e chiarezza |
| Quotidiano | Materia comune della poesia |
| Antiretorica | Rifiuto dell'enfasi e del poeta-vate |
| Poetica dell'oggetto | Oggetti concreti come segni esistenziali |
| Correlativo oggettivo | Immagine concreta che esprime uno stato interiore |
| Classicismo | Ricerca di misura e ordine formale |

## Sintesi finale

La linea antinovecentista è una tendenza della poesia italiana che rifiuta l'oscurità ermetica e la retorica del poeta-vate. Cerca una poesia più chiara, concreta, quotidiana e comunicativa.

Saba ne rappresenta l'esempio più limpido con la sua poesia onesta; Montale vi si collega per l'antiretorica e la centralità degli oggetti; Cardarelli per il ritorno alla misura classica.
