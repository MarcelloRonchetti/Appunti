...
Un'altra influenza è la poesia metafisica europea, in particolare **T. S. Eliot**.
...
## 5. Gli autori ermetici

Gli autori più legati all'Ermetismo sono:

- **Salvatore Quasimodo**, soprattutto nella prima fase;
- **Mario Luzi**;
- **Alfonso Gatto**;
- **Leonardo Sinisgalli**;
- **Piero Bigongiari**.

Il centro culturale più importante è **Firenze**, con riviste come:
...
Quasimodo rappresenta bene l'evoluzione della poesia ermetica.

Nella prima fase, con raccolte come *Acque e terre* ed *Erato e Apollion*, usa un linguaggio allusivo, concentrato e musicale.

Dopo la Seconda guerra mondiale cambia direzione: la tragedia storica lo porta verso una poesia più civile e comunicativa. Un testo simbolico di questa svolta è *Alle fronde dei salici*, in cui il poeta riflette sull'impossibilità di cantare mentre il mondo è devastato dalla guerra.
...
| Termine | Significato |
|---|---|
| Ermetismo | Poesia concentrata, oscura, allusiva |
| Poesia pura | Poesia autonoma, non narrativa e non esplicativa |
| Analogia | Accostamento intuitivo tra immagini lontane |
| Simbolo | Immagine concreta che rimanda a significati profondi |
| Parola essenziale | Parola isolata e carica di valore espressivo |
| Sintassi nominale | Frasi senza verbo o con struttura ridotta |
| Bianco tipografico | Spazio della pagina che crea pausa e silenzio |
| Correlativo oggettivo | Oggetto che esprime uno stato interiore |

## Sintesi finale

L'Ermetismo è una poesia della concentrazione e del mistero. Nasce in un'epoca di crisi storica e culturale e rifiuta la retorica ufficiale, cercando una parola pura, essenziale, capace di evocare più che spiegare.

Ungaretti ne è il principale precursore; Quasimodo, Luzi, Gatto e Sinisgalli ne sono tra gli esponenti più importanti. La poesia ermetica non mira alla chiarezza immediata, ma alla rivelazione di una verità interiore attraverso simboli, analogie e silenzi.
