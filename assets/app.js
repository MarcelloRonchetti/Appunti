const pages = [
  ...
  },
  {
    ...
    path: "Sto-Ita/italiano/autori/01-giovanni-verga.md",
  },
  {
    group: "Italiano - autori",
    title: "Giovanni Pascoli",
    path: "Sto-Ita/italiano/autori/02-giovanni-pascoli.md",
  },
  {
    group: "Italiano - autori",
    title: "Gabriele D'Annunzio",
    path: "Sto-Ita/italiano/autori/03-gabriele-dannunzio.md",
  },
  {
    group: "Italiano - autori",
    title: "Italo Svevo",
    path: "Sto-Ita/italiano/autori/04-italo-svevo.md",
  },
  {
    group: "Italiano - autori",
    title: "Luigi Pirandello",
    path: "Sto-Ita/italiano/autori/05-luigi-pirandello.md",
  },
  {
    group: "Italiano - autori",
    title: "Giuseppe Ungaretti",
    path: "Sto-Ita/italiano/autori/06-giuseppe-ungaretti.md",
  },
  {
    group: "Italiano - autori",
    title: "Eugenio Montale",
    path: "Sto-Ita/italiano/autori/07-eugenio-montale.md",
  },
  {
    group: "Italiano - autori",
    title: "Italo Calvino",
  ...
  },
  {
    ...
    path: "Sto-Ita/italiano/movimenti/01-positivismo-naturalismo-verismo.md",
  },
  {
    group: "Italiano - movimenti",
    title: "Decadentismo, Simbolismo ed Estetismo",
    path: "Sto-Ita/italiano/movimenti/02-decadentismo-simbolismo-estetismo.md",
  },
  {
    group: "Italiano - movimenti",
    title: "Avanguardie, Futurismo e Crepuscolarismo",
    path: "Sto-Ita/italiano/movimenti/03-avanguardie-futurismo-crepuscolarismo.md",
  },
  {
    group: "Italiano - movimenti",
    title: "Romanzo della crisi",
    path: "Sto-Ita/italiano/movimenti/04-romanzo-della-crisi.md",
  },
  {
    group: "Italiano - movimenti",
    title: "Ermetismo",
    path: "Sto-Ita/italiano/movimenti/05-ermetismo.md",
  },
  {
    group: "Italiano - movimenti",
    title: "Neorealismo",
    path: "Sto-Ita/italiano/movimenti/06-neorealismo.md",
  },
  {
    group: "Italiano - movimenti",
    title: "Linea antinovecentista",
    path: "Sto-Ita/italiano/movimenti/07-linea-antinovecentista.md",
  },
  {
    group: "Italiano",
